...
3. See [jetson_node/README.md](SabrePatrolLPR/jetson_node/README.md) for detailed instructions.
...
4. See [mdt_client/README.md](SabrePatrolLPR/mdt_client/README.md) for detailed end-user instructions.
